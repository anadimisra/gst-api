...
Feature: Customer Information and Preferences Management
  ...
  Scenario: Adding new customer send notification to the customer contact
	...
	Scenario: Updating customer contact send notification email to new contact
	...
	Scenario: Updating brach contact of a customer notifies the new branch contact
